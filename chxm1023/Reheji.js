...
[rewrite_local]
^https:\/\/api\.revenuecat\.com\/.+\/(receipts$|subscribers\/?(.*?)*$) url script-response-body https://raw.githubusercontent.com/yaheex/Qx/main/yahee/Reheji.js
^https:\/\/api\.revenuecat\.com\/.+\/(receipts$|subscribers\/?(.*?)*$) url script-request-header https://raw.githubusercontent.com/yaheex/Qx/main/yahee/Reheji.js
...
const list = {
	...
	'IPTVUltra': { name: 'premium', id: 'com.yahee.lifetime', cm: 'sjb' },  //IPTVUltra
	...
	'ScannerPro': { name: 'plus', id: 'com.yahee1.premium.yearly', cm: 'sja' },  //Scanner Pro-文档扫描
...
try {
  if (typeof $response == "undefined") {
    ...
    delete headers["X-RevenueCat-ETag"];
    yahee1.headers = headers;
  } else if (yahee && yahee.subscriber) {
    yahee.subscriber.subscriptions = yahee.subscriber.subscriptions || {};
    yahee.subscriber.entitlements = yahee.subscriber.entitlements || {};
    ...
    yahee.subscriber.entitlements[name] = Object.assign({}, data, { product_identifier: ids });
    if (typeof nameb !== 'undefined' && nameb !== null) {
      yahee.subscriber.entitlements[nameb] = Object.assign({}, data, { product_identifier: idb });
    }
    const subData = Object.assign({},data,{		"Author": "yahee",		"Telegram": "https://t.me/yahee",		"warning": "仅供学习，禁止转载或售卖",		"original_purchase_date": "2023-09-09T09:09:09Z",		"store_transaction_id" : "4900066666666666",		"period_type" : "trial",		"store": "app_store",		"ownership_type": "PURCHASED"	});
    yahee.subscriber.subscriptions[ids] = subData;
    if (typeof idb !== 'undefined' && idb !== null) {
      yahee.subscriber.subscriptions[idb] = subData;
    }
